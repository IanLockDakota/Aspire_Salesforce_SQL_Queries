...
SELECT	
	...
	'USD' AS CURRENCY, 
	CASE WHEN JournalNumber IN (SELECT JournalNumber WHERE AccountId IN ('01-20025', '01-10040')) THEN 'Draft' 
	ELSE (CASE WHEN ProcessOid IN (20119, 20121, 20143) OR ContractID IS NULL THEN 'Draft' ELSE 'Post' END) END AS STATE, 
...
WHERE 
	...
	AND SageAccount IN ('42001', '42002')
